...
function makeStyles(isDark: boolean) {
  ...
  promptCard: { borderRadius: 18, borderWidth: 1, borderColor: 'rgba(201,168,76,0.22)', backgroundColor: GOLD_SOFT_J, padding: 16, marginBottom: 24 , shadowColor: isDark ? '#000' : '#1C1410', shadowOffset: { width: 0, height: 3 }, shadowOpacity: isDark ? 0.25 : 0.10, shadowRadius: isDark ? 10 : 8, elevation: isDark ? 6 : 4 },
  ...
  entryCard: { borderRadius: 18, borderWidth: 1, borderColor: GLASS_BORDER_J, backgroundColor: GLASS_BG_J, padding: 14, marginBottom: 12 , shadowColor: isDark ? '#000' : '#1C1410', shadowOffset: { width: 0, height: 3 }, shadowOpacity: isDark ? 0.25 : 0.10, shadowRadius: isDark ? 10 : 8, elevation: isDark ? 6 : 4 },
