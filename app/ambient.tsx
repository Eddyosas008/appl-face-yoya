...
const styles = StyleSheet.create({
  ...
  stopAllBtn: { borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6 },
  stopAllText: { fontSize: 12, fontWeight: '600' },
  playingBanner: { borderRadius: 12, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 },
  playingDot: { width: 8, height: 8, borderRadius: 4 },
  playingText: { fontSize: 13, fontWeight: '600' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 20 },
  soundCard: { width: '47%' },
  soundCardInner: { borderRadius: 18, padding: 16, minHeight: 110, justifyContent: 'flex-end', overflow: 'hidden' },
  soundCardActive: { borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)' },
  ...
  soundLabel: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' },
  activeIndicator: { marginTop: 6, backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, alignSelf: 'flex-start' },
  activeText: { color: '#FFFFFF', fontSize: 10, fontWeight: '600' },
  timerCard: { borderRadius: 18, padding: 16, marginBottom: 14 },
  timerTitle: { fontSize: 16, fontWeight: '700', marginBottom: 4 },
  timerSubtitle: { fontSize: 12, marginBottom: 14 },
  timerOptions: { flexDirection: 'row', gap: 8, marginBottom: 14, flexWrap: 'wrap' },
  timerOption: { borderRadius: 999, paddingHorizontal: 14, paddingVertical: 7 },
  timerOptionText: { fontSize: 13, fontWeight: '600' },
  startTimerBtn: { borderRadius: 999, paddingVertical: 12, alignItems: 'center' },
  startTimerText: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' },
  timerRunning: { alignItems: 'center', gap: 12 },
  timerCountdown: { fontSize: 48, fontWeight: '800' },
  timerStopBtn: { borderRadius: 999, paddingHorizontal: 20, paddingVertical: 8 },
